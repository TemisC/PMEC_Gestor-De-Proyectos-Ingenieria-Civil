// Subconjunto de components/ui/Icons.tsx del SPA original — mismo
// lenguaje visual (outline, stroke=currentColor), solo los que este MVP
// necesita hasta ahora.
...
export function ExternalCollabIcon({ className }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export function TeamGlobalIcon({ className }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
