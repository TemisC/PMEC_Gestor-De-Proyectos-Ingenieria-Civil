...
export const ACTION_LABELS: Record<string, string> = {
  ...
  "time_entry.import":             "importó fichajes de Odoo",
  "work_range.create":             "agregó un rango de horas proyectadas",
  "work_range.update":             "editó un rango de horas proyectadas",
  "work_range.delete":             "eliminó un rango de horas proyectadas",
